...
export function getDb(): SqliteDatabase.Database {
  ...
  sqlite.exec(`
    ...
    CREATE TABLE IF NOT EXISTS character_asset_states (
    ...
    CREATE TABLE IF NOT EXISTS character_authoring_attempts (
    ...
    CREATE INDEX IF NOT EXISTS idx_character_authoring_owner_updated
    ...
    CREATE TABLE IF NOT EXISTS narration_style_asset_states (
      narration_style_id TEXT PRIMARY KEY,
      compatibility_status TEXT NOT NULL CHECK (
        compatibility_status IN ('unsupported', 'upgrading', 'upgrade_failed', 'ready')
      ),
      current_generation_id TEXT,
    ...
    CREATE TABLE IF NOT EXISTS narration_style_authoring_attempts (
      attempt_id TEXT PRIMARY KEY,
      owner_user_id TEXT NOT NULL REFERENCES users(id) ON DELETE CASCADE,
    ...
    CREATE INDEX IF NOT EXISTS idx_narration_style_authoring_owner_updated
