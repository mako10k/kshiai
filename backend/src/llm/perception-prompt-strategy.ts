...
When environmentProposal.authority is present, it is the complete evolution permission: touch only listed objectRefs and listed battlefield areaRefs, express only its pressure, and do not create topology or another object/effect outside it. If the proposal cannot produce a valid durable transition within that authority, reject it.
