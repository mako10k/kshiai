...
Choose reflect only when the fight looks unfavorable, the character is cautious/deliberative, or other available actions look thin. Never choose reflect for short-tempered or impulsive personalities. Reflect spends the whole turn: no damage, only private analysis and a forward guideline written into memory.`;
