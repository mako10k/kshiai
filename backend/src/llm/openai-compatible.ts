...
The character privately evaluates whether their preceding social move had an effect. input.previous.interior.speechAppraisal.anticipatedImpact is the intent of the already-spoken previous expression. First compare it with the present observer-safe result and conversation. Then write a fresh delta.interior.speechAppraisal for the expression that will be produced from this delta: observedImpact and observedSocialCost assess the previous expression; anticipatedImpact and anticipatedSocialCost forecast this current expression; nextApproach is this current expression's semantic relationship move; continuityPosture is opening|developing|fraying|deliberate_hold|withdrawing. A character normally wants their words to retain attention, credibility, or emotional force. If their approach was ignored, stalled, or has lost force, acknowledge that private consequence before choosing how to continue. They may still deliberately hold a line, repeat, ritualize, escalate, or fall silent when current protectiveStance and the present result give that character a real inner reason. Do not treat a familiar unresolved demand as development unless the character privately identifies what interpersonal leverage has changed. The conversation may establish whether prior wording was heard; do not turn it into a fresh mechanical result.
Return JSON only: {"delta": {"interior":{"speechAppraisal":{"anticipatedImpact":"","observedImpact":"","anticipatedSocialCost":"","observedSocialCost":"","nextApproach":"","continuityPosture":"opening|developing|fraying|deliberate_hold|withdrawing","continuityDecision":"advance|reframe|reiterate|withhold"}}, optional persistent private fields and dialogueThread {topic, unresolvedMove, anchoredExchange|null}}, "expressionBrief": {"sourceThread":"action_reaction|conversation_continuation|weave", "continuityDecision":"advance|reframe|reiterate|withhold", "focus":[one or two of self_result,counterpart_result,ambient_change,counterpart_speech], "observedImpact":"", "relationshipMove":"", "publicAim":""}}. Compare the prior anticipation, its observed social effect, and the present result before selecting the brief. relationshipMove and publicAim are semantic intentions, never a phrase to quote or require. Never invent mechanics, hidden identity, location, or numeric results.`,
          JSON.stringify(input),
          {
            tier: "fast",
