...
仮説優先の本番戦闘パイプライン実装・試行計画: [docs/battle-pipeline-production-rollout.md](docs/battle-pipeline-production-rollout.md) / [PERT](docs/battle-pipeline-execution.pert) / [実績・Velocity](docs/battle-pipeline-actuals.md)
