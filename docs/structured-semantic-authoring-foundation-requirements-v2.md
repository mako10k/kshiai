# Structured semantic authoring foundation — requirement candidate revision 2

- Status: Step 1 candidate; self-review complete; owner review pending
- Date: 2026-09-11
- Replaces for review: structured-semantic-authoring-foundation-requirements-v1.md
- Revision basis: revision 1 independent review and owner clarifications on retry and preservation access.
...
The pending character V3 authoring candidate revision 3 is supporting proposal
material, not accepted authority. Its R14 same-attempt continuation and R19
nonterminal-failure wording must be aligned in a separately reviewed successor
candidate before adoption. No historical document or accepted ADR is rewritten here.

### Changes from foundation revision 1

Revision 2 adds the above authority map, permits failed attempts with source-based
retry without mandatory intermediate-context persistence, and restricts preservation
reads to migrators during migration. All other foundation requirements retain their
revision 1 scope.
