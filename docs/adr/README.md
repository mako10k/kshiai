...
| [0032](0032-bind-v3-characters-to-versioned-battles.md) | Accepted | Bind two V3 character generations in a distinct immutable battle manifest without changing historical manifest meanings |
