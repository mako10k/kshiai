# ADR-0024: Separate Compact expression state and utterance history
...
- Authority: `0024-expression-state-and-utterance-actuals.think`
...
OWNER_ACCEPTANCE: on 2026-09-08, after this ADR and its
content-independent repetition handling were explained, the product owner
instructed, "では、一旦これで固めましょう。" The accepted pre-acceptance
`.think` snapshot had SHA-256
...
This ADR is Accepted at the owner-approved revision. Acceptance fixes the
