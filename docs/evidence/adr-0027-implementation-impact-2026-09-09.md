...
履歴資料: 以下はADR-0027受入時の基線調査。現在はADR-0028 revision 2を承認後、V3を実装中。
旧V1/V2経路の記述は互換確認に引き続き利用できるが、V3へ一般化しない。
7タグには旧世代・残存理由を記した。今回の変更と残検証は[別記録](agency-v3-local-verification-2026-09-09.md)を参照。
